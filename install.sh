...
ln -s /share/Data/Nzbget-Scripts/ArchiveFilter.py ArchiveFilter.py
ln -s /share/Data/Nzbget-Scripts/Completion.py Completion.py
ln -s /share/Data/Nzbget-Scripts/EventHelper.py EventHelper.py
